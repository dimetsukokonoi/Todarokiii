...
function getPriorityIcon(priority) {
  switch(priority) {
    case 'high': return { icon: 'arrow_upward', colorClass: 'text-red-500 animate-pulse', bgClass: 'bg-red-500/10' };
    case 'medium': return { icon: 'remove', colorClass: 'text-yellow-500', bgClass: 'bg-yellow-500/10' };
    case 'low': return { icon: 'arrow_downward', colorClass: 'text-green-500', bgClass: 'bg-green-500/10' };
